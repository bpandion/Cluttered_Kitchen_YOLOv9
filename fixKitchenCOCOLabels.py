...
# os.rename('.\\KitchenCOCOv2-5','.\\KitchenCOCOv2-5_coco')
...
coco_master_path = '.\\KitchenCOCOv2-5_coco'
...
for txt in txts:
    with open(old_label_path+'\\'+txt, "r") as file:
        ...
        for line in split_content:
            class_id = int(line[0])
            classname = kitchencoco_names[class_id]
            for c in coco_names:
                if (coco_names[c] == classname):
                    correct_str = str(c)
                    break
...
print("DONE!")
print("You can now delete .\\KitchenCocov2-5_coco, it's no longer used.")