...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'KitchenLVIS-2/data.yaml', help='dataset.yaml path')
    # parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolo.pt', help='model path(s)')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'AllWeights/fullTrain.pt', help='model path(s)')
    ...
    parser.add_argument('--name', default='KitchenLVIS2_auf_fulltrain_fixedConfusion', help='save to project/name')
